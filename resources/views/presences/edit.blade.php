            ...
            <div class="card-body">
                ...
                <form action="{{ route('presences.update', $presence->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control datetime @error('check_in') is-invalid @enderror" id="check_in" name="check_in" required value="{{ old('check_in', $presence->check_in) }}">
                        @error('check_in')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control datetime @error('check_out') is-invalid @enderror" id="check_out" name="check_out" required value="{{ old('check_out', $presence->check_out) }}">
                        @error('check_out')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control date @error('date') is-invalid @enderror" id="date" name="date" required value="{{ old('date', $presence->date) }}">
                        @error('date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
