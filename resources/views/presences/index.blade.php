                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('presences.destroy', $presence->id) }}" class="delete-form" method="POST" style="display: inline;" data-title='Yakin menghapus presence ini?' data-message='Data presence akan dihapus permanen!'>
                                    @csrf
                                    @method('DELETE')
