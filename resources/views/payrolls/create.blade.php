            ...
            <div class="card-body">
                ...
                <form action="{{ route('payrolls.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('bonuses') is-invalid @enderror" id="bonuses" name="bonuses" value="{{ old('bonuses') }}" required>
                        @error('bonuses')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('deductions') is-invalid @enderror" id="deductions" name="deductions" value="{{ old('deductions') }}" required>
                        @error('deductions')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control date @error('pay_date') is-invalid @enderror" id="pay_date" name="pay_date" value="{{ old('pay_date') }}" required>
                        @error('pay_date')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('net_salary') is-invalid @enderror" id="net_salary" name="net_salary" disabled>
                        @error('net_salary')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
