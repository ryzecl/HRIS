                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('payrolls.destroy', $payroll->id) }}" class="delete-form" method="POST" style="display: inline;" data-title='Yakin menghapus payroll ini?' data-message='Data payroll akan dihapus permanen!'>
                                    @csrf
                                    @method('DELETE')
